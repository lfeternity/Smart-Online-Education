  ...
  <div class="classLearning">
    ...
    <div class="learn" :class="{close: isClose}">
      ...
      <div class="cont">
        ...
        <div class="ai" v-if="actId == 4">
          <AIAssistant :context="{ courseId: currentPlayData.courseId, chapterId: currentPlayData.chapterId, sectionId: currentPlayData.sectionId, playMoment: Math.floor(currentPlayTime), page: pageType == 2 ? 'practice' : 'video' }" />
        </div>
      </div>
    </div>
    <!-- 右侧弹出问答、笔记 - start -->
...
const detailsId = ref({})
// 课程信息及讲师信息
const tableBar = [{id: 1, name: '目录'}, {id: 2, name: '问答'}, {id: 3, name: '笔记'}, {id: 4, name: 'AI 助教'}]
// 课程目录
