  ...
  <header class="bg-wt">
    <div class="container fx">
      ...
      <div class="fx-al-ct pt-rt">
        <el-tooltip v-if="userInfo && userInfo.name" content="AI 学习助理" placement="bottom">
          <button class="ai-entry fx-al-ct" type="button" @click="aiOpen = true"><ChatDotRound/><span>AI 助教</span></button>
        </el-tooltip>
        ...
        <div class="fx-al-ct" v-if="userInfo && userInfo.name">
          <img class="headIcon" :src="userInfo.icon || defaultImage" :onerror="onerrorImg" alt="">
    ...
    <el-drawer v-model="aiOpen" title="AI 学习助理" size="min(420px, 100vw)" append-to-body destroy-on-close>
      <AIAssistant mode="global" />
    </el-drawer>
  </header>
</template>
<script setup>
...
import AIAssistant from '@/pages/learning/components/AIAssistant.vue'
